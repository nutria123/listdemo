...
public class backupOfDetailActivity extends Activity implements OnItemSelectedListener,
		ViewFactory {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (Extra != null) {
			...
			gl.setAdapter(new DetailImageAdapter(backupOfDetailActivity.this, list, gl));
	...
	private Button.OnClickListener dlbutton_listener = new Button.OnClickListener() {
		public void onClick(View v) {
			...
			String bigpicurl = picurl.replace("sm", "b").replace("thumbs",
					"photos");
			String picname=bigpicurl.substring(bigpicurl.lastIndexOf('/')+1);
			try{
